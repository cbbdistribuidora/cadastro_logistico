...
const Step2 = ({ produto, dados, setDados, nextStep }: any) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <input className="w-full border p-2" name="embalagem" placeholder="Embalagem (Ex: CX 4X10)" onChange={handleChange} />
